...
mysql> select  bname from boats b,reserves r1,sailors s1 where s1.sid=r1.sid and b.bid=r1.bid and s1.sname='lubber' and b.bid in(select b2.bid from boats b2,reserves r2,sailors s2 where b2.bid=r2.bid and s2.sid=r2.sid and s2.sname='dustin');
+-----------+
| bname     |
+-----------+
| interlate |
